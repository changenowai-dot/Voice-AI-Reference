...
LOANWORDS_DE: dict[str, str] = {
    ...
    # --- Digital / Alltag (DE_FOREIGN_DIGITAL) ----------------------------
    "Community": "Kommjunitti",
    "Content": "Kontent",
    "Creator": "Krieitor", "Creators": "Kreitoren",
    "Story": "Stori", "Stories": "Storis",
    "Voice": "Wois",
    "Design": "Disain",
    "Performance": "Per-FOR-mens",
    "Feature": "Fitscher", "Features": "Fitschers",
    "Update": "Apdeit", "Updates": "Apdeits",
    "Workflow": "Wörk-flow",
    "System": "SÜS-tem",
    "Interface": "IN-ter-fäs",
    "Online": "On-lein",
    "Offline": "Off-lein",
    "Business": "BIS-sness",
    "Mindset": "Meindset",
    "Coaching": "Koutsching",
    "Podcast": "Pod-kast", "Podcasts": "Pod-kasts",
    "Livestream": "Laif-strim",
    "Browser": "Brauser",
    "Server": "Ser-wer",
    "Backend": "Bäck-end",
    "Frontend": "Frant-end",
    "User": "Ju-ser", "Userin": "Ju-se-rin",
    "Nutzer": "NUT-zer",  # deutsch, nur zur Sicherheit
    "Cloud": "Klaud",
    "Account": "E-kaunt", "Accounts": "E-kaunts",
    "Upload": "App-load",
    "Download": "Daun-load", "Downloads": "Daun-loads",
    "Login": "Log-in",
    "Logout": "Log-out",
    "Link": "Link", "Links": "Links",
    "Event": "I-went", "Events": "I-wents",
    "Tool": "Tuhl", "Tools": "Tuhls",
    "Startup": "Start-ap",
    "Pitch": "Pitsch",
    "Launch": "Lontsch",
    "Feedback": "Fid-bek",
    ...
    "Screenshot": "Skrien-schot",
    "E-Mail": "I-mehl", "Email": "I-mehl",
}
