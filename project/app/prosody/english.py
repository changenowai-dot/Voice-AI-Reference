...
PAUSE_STRATEGIES_EN: dict[str, dict] = {
    ...
    # English narrative documentary: tighter than German narrative but
    # clearly audible; clause pauses shorter than DE because English
    # punctuation serves different rhythmic function.
    "narrative": {
        "statement": 0.50,
        "question": 0.70,
        "rhetorical_question": 0.90,
        "exclamation": 0.66,
        "explanation": 0.54,
        "contrast": 0.66,
        "emphasis": 0.70,
        ...
        "quote_end": 0.86,
        "end_of_text": 1.25,
        "after_comma": 0.24,       # lighter comma breath vs German
        "after_semicolon": 0.46,
        "after_colon": 0.46,
        "after_dash": 0.48,
        "after_ellipsis": 0.60,
        "in_list": 0.46,
