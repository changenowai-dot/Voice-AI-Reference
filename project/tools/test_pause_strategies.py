...
def test_narrative_clause_pauses():
    ...
    cases = [
        ("Each time we read it,",                            "comma",      0.34),
        ("Not merely recount events;",                        "semicolon",  0.56),
        ("Something new surfaces:",                           "colon",      0.60),
        ("Then came the quiet —",                             "dash",       0.64),
        ("The room fell silent…",                             "ellipsis",   0.72),
    ]
